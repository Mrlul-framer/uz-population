...
export function ErrorState({ message, onRetry }: ErrorStateProps) {
  return (
    <div className="flex flex-col items-center justify-center rounded-xl border border-clay-400/30 bg-clay-400/5 px-6 py-16 text-center dark:border-clay-500/30 dark:bg-clay-500/10">
      <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-clay-500/10 text-clay-500">
